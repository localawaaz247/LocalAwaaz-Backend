...
const Notification = new mongoose.Schema({
    ...
    type: {
        ...
        enum: [
            ...
            'ISSUE_LOCKED', 'ISSUE_FLAGGED', 'ISSUE ORPHANED', 'ISSUE_DISPUTED', 'ACCOUNT_SUSPENDED', 'ACCOUNT_BANNED', 'ACCOUNT_RESTORED',
            'AUTHORITY_APPROVED', 'AUTHORITY_REJECTED', 'AUTHORITY_REVERTED', 'NEW_AUTHORITY_APPLICATION'
        ],
        required: true
    },
    message: {
